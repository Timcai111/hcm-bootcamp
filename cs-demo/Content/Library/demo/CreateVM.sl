...
flow:
  ...
  inputs:
    - host: 10.0.46.10
    - username: "CAPA1\\1035-capa1user"
    - password: Automation123
    - datacenter: CAPA1 Datacenter
    - image: Ubuntu
    - folder: Students/TimCai
    - prefix_list: '1-,2-,3-'
  workflow:
    - uuid:
        do:
  ...
  graph:
    steps:
      ...
      wait_for_vm_info:
        ...
        y: 118
        navigate:
          35c41552-c4a4-386d-1df6-a7e4f96291f4:
            targetId: a5df386b-54fc-534f-e4c5-cf3105ec399d
            port: SUCCESS
    results:
      SUCCESS:
        a5df386b-54fc-534f-e4c5-cf3105ec399d:
          x: 620
          y: 297
